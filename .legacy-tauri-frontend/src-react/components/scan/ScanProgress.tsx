...
export const ScanProgress: React.FC = () => {
  ...
  const getStatusBadgeClasses = () => {
    ...
    return 'bg-gradient-to-b from-gray-300 to-gray-400 dark:from-gray-600 dark:to-gray-700 text-gray-700 dark:text-gray-300';
  };
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-800/95 rounded-2xl border border-gray-200 dark:border-gray-700/50 shadow-card p-5 mt-4">
      {/* Header Row */}
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <span className="text-blue-600 dark:text-blue-400 font-medium">{devices.length}</span>
          <span className="ml-1.5 text-gray-500 dark:text-gray-500">devices found</span>
        </div>
      </div>

      {/* Progress Bar */}
      <div className="relative w-full h-3 bg-gray-200 dark:bg-gray-700/70 rounded-full overflow-hidden shadow-inner">
        <div
          className={twMerge(
            clsx(
      ...
      {/* Progress Stats */}
      <div className="flex justify-between mt-3 text-xs text-gray-500 dark:text-gray-500 font-medium">
        <span className="text-blue-600 dark:text-blue-400">{progressPercent}% complete</span>
      ...
      <div className="flex gap-5 mt-5">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center p-4 bg-gray-100 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700/30">
            <div className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 dark:from-blue-500 dark:to-blue-400 bg-clip-text text-transparent">
              {progressPercent}%
            </div>
            <div className="text-xs text-gray-500 dark:text-gray-500 mt-2 font-medium uppercase tracking-wider">
